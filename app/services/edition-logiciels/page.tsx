                ...
                <div className="grid md:grid-cols-3 gap-8 mb-16">
                    <div className="md:col-span-2">
                        <div className="bg-brand-navy p-8 rounded-2xl border border-white/10 shadow-2xl">
                            <h2 className="text-2xl font-bold mb-6 text-brand-orange">Notre approche</h2>
                    ...
                    <div className="bg-brand-orange/10 p-8 rounded-2xl border border-brand-orange/20 flex flex-col justify-center items-center text-center">
                        <h3 className="text-xl font-bold mb-4">Besoin d'un Logiciel ?</h3>
                        <p className="text-sm text-gray-400 mb-6">Optimisez vos processus avec une application métier performante.</p>
                        <Link
                            href="/#contact"

            ...
            <div className="container mx-auto max-w-4xl px-4 md:px-8">
                ...
                <div className="grid md:grid-cols-3 gap-8 mb-16">
                    ...
                    <div className="bg-brand-orange/10 p-8 rounded-2xl border border-brand-orange/20 flex flex-col justify-center items-center text-center">
                        <h3 className="text-xl font-bold mb-4">Infrastructure stable ?</h3>
                        <p className="text-sm text-gray-400 mb-6">Confiez-nous la maintenance de votre parc informatique.</p>
                        <Link
                            href="/#contact"
